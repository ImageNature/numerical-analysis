...
\documentclass[12pt,letterpaper,final,twoside,fleqn]{book}
...
\usepackage[letterpaper,outer=1in,inner=1in,top=1.2in,bottom=1.0in,footskip=0.4in, marginparwidth=1cm, marginparsep=0.5cm,headsep=1cm,footnotesep=4mm plus 4pt minus 4pt]{geometry}
